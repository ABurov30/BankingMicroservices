...
public class OutboxConfiguration {
  ...
  @Bean
  public OutboxDispatcher<AuthOutboxEventEntity> outboxDispatcher(
    ...
    Gauge.builder(
        ...
        .tag("outbox", "auth_outbox_events")
        .register(meters);
    meters.counter("outbox.retry", "outbox", "auth_outbox_events");
    var store =
        new JpaOutboxAttemptStore<>(
            entityManager,
            transactionManager,
            AuthOutboxEventEntity.class,
            "auth_outbox_events",
            properties);
    return new OutboxDispatcher<>(
        store, properties, transactionManager, meters, "auth_outbox_events");
  }

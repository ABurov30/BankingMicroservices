...
public interface CardRepository extends JpaRepository<CardEntity, UUID> {
  ...
  @Query("UPDATE CardEntity c SET c.spendDailyLimit = :limit WHERE c.spendDailyLimit <> :limit")
  int resetSpendDailyLimit(@Param("limit") BigDecimal limit);

  @Modifying(clearAutomatically = true, flushAutomatically = true)
  @Query("UPDATE CardEntity c SET c.spendMonthlyLimit = :limit WHERE c.spendMonthlyLimit <> :limit")
  int resetSpendMonthlyLimit(@Param("limit") BigDecimal limit);

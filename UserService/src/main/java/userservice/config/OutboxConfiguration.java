...
public class OutboxConfiguration {
  ...
  @Bean
  public OutboxDispatcher<UserOutboxEventEntity> outboxDispatcher(
    ...
    Gauge.builder(
        ...
        .tag("outbox", "user_outbox_events")
        .register(meters);
    meters.counter("outbox.retry", "outbox", "user_outbox_events");
    var store =
        new JpaOutboxAttemptStore<>(
            entityManager,
            transactionManager,
            UserOutboxEventEntity.class,
            "user_outbox_events",
            properties);
    return new OutboxDispatcher<>(
        store, properties, transactionManager, meters, "user_outbox_events");
  }

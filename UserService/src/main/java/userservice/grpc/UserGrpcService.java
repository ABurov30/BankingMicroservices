...
public class UserGrpcService extends UserRpcServiceGrpc.UserRpcServiceImplBase {
  ...
  public void getUserHealth(
      Empty request, StreamObserver<GetUserHealthGrpcResponse> responseObserver) {
    GetUserHealthGrpcResponse response =
        GetUserHealthGrpcResponse.newBuilder()
            .setMessage("User service GRPC health " + LocalDateTime.now())
            .build();
  ...
  public void getUserInfo(
      GetUserInfoGrpcRequest request, StreamObserver<GetUserInfoGrpcResponse> responseObserver) {
    GetUserInfoCommand getUserInfoCommand = commandMapper.toGetUserInfoCommand(request);
    GetUserInfoGrpcResponse response =
        grpcMapper.toGetUserInfoGrpcResponse(userService.getUserInfo(getUserInfoCommand));
  ...
  public void getAllUserInfo(
      Empty request, StreamObserver<GetAllUserInfoGrpcResponse> responseObserver) {

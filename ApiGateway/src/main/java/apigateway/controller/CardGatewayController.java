...
public class CardGatewayController {
    ...
    public CreateCardResponseDto createCard(
        ...
        return cardQueryHandler.createCard(request, UUID.fromString(jwt.getSubject()), cookieConfig.extractRole(jwt));
    }
    ...
    public UpdateCardResponseDto updateCard(
        ...
        Jwt jwt = cookieConfig.getAccessTokenJwt(httpRequest);
        return cardQueryHandler.updateCard(request, UUID.fromString(jwt.getSubject()), cookieConfig.extractRole(jwt));
    }
}

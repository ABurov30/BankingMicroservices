...
public interface TransactionGrpcMapper {
    ...
    default GetTransactionsByAccountsGrpcRequest toGetTransactionsByAccountsGrpcRequest (List<AccountResponse> accountResponseList) {
    ...
    default TransactionResponseDto toTransactionResponseDto (TransactionResponse response) {
        return new TransactionResponseDto(
                ...
                response.hasSourceAccount()
                        ? toGetAccountResponseDto(response.getSourceAccount())
                        : null,
                response.hasTargetAccount()
                        ? toGetAccountResponseDto(response.getTargetAccount())
                        : null
        );
    }

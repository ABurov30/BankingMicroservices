...
public class GlobalExceptionHandler {
  ...
  public ResponseEntity<ApiErrorResponse> handleGrpcException(
    ...
    log.error(
        "gRPC request failed: httpMethod={}, requestUri={}, status={}, description={}",
        request.getMethod(),
  ...
  public ResponseEntity<ApiErrorResponse> handleRuntimeException(
      MissingAccessTokenException exception) {
    log.error(
        "Access token exception cause={}, description={}",
        exception.getCause(),
    ...
    ApiErrorResponse response =
        new ApiErrorResponse(
            Instant.now(), HttpStatus.UNAUTHORIZED.value(), "Unauthorized", messages);
  ...
  public ResponseEntity<ApiErrorResponse> handleRuntimeException(
    ...
    log.error(
        "Refresh token exception cause={}, description={}",
        exception.getCause(),
        exception.getMessage(),
        exception);
  ...
  public ResponseEntity<ApiErrorResponse> handleValidationException(
    ...
    log.error(
        "Validation exception cause={}, description={}",
        exception.getCause(),
        exception.getMessage(),
        exception);

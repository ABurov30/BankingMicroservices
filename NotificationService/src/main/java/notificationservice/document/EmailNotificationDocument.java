...
public class EmailNotificationDocument {
  ...
  @NotNull private EmailNotificationType type;
  private String verificationCode;

  @NotNull private EmailNotificationStatus status = EmailNotificationStatus.PENDING;

  @NotNull private LocalDateTime createdAt = LocalDateTime.now();
  @NotNull private LocalDateTime nextRetryAt = LocalDateTime.now();
